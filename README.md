...
Чат-приложение, которое использует API OpenRouter для взаимодействия с различными моделями ИИ.
...
2. **Клонирование проекта**
   ...
   git clone https://github.com/GarryFerstein/DesktopAIChat.git
